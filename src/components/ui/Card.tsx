...
export default function Card({ paises, priority }: Props) {
  ...
  return (
    <div className="relative w-full bg-royal-blue-200 rounded-md border border-royal-blue-100 shadow-md shadow-royal-blue-400 h-full">
      <Dialog>
        <DialogTrigger asChild>
          <div className="p-10 flex flex-col items-center gap-2 hover:bg-royal-blue-250 transition-colors duration-300 ease-in-out rounded-md">
            ...
            <h2 className="font-bold text-center line-clamp-1">{paises.name.common}</h2>
            <p>{paises.region}</p>
      ...
      <button
        type="button"
        className="absolute top-0 right-1 p-2 bg-royal-blue-900 hover:bg-royal-blue-950 rounded-b-md cursor-pointer"
